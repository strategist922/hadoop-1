...
c_cons_temp_grouped = group c_all_temp by $0;

--y = limit c_cons_temp_grouped 2;
--dump y;

c_corr = foreach c_cons_temp_grouped generate group, COR( $1.$3, $1.$4  );

STORE c_corr INTO 'pig_corr_v2' USING PigStorage (',');
